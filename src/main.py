...
class Reinstruccion:
    ...
    def generar_nombre(self):
        ...
        return f"{self.conductor.nombre_conductor}_{fecha_sin_barras}_{self.reinstructor.nombre_reinstructor}" ##esta debe ser elnombre de Jaime Lique Tinte - (Leopoldo Nuñez Cerna / Tipo 1) seria Conductor - (Reinstructor /gravedad)## 
